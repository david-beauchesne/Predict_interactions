...
% old version
% where wt is the weight given to the to sets of resources or consumers for
% consumer TC and resources TR (replace TC in equation 2), for taxa x and y.
% TT is the taxonomy of taxa x and y.
