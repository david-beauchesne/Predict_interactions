...
\begin{table}[h!]
    ...
    \begin{tabularx}{1\textwidth}{|s|b|}
        ...
        \hline
  \end{tabularx}
    \caption{List of functional groups included in the dataset presented in Savenkoff et al. (2004) with their taxa composition. Only taxa that were at least at the scale of the family were used to predict interactions using the XXX algorithm. List adapted from Savenkoff et al. (2004).}
\end{table}
